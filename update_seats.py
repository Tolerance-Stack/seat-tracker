...
def fetch_seat_data():
    # CSS is embedded directly here so it looks good in the Wix Iframe
    html = """
    <!DOCTYPE html>
    <html>
    <head>
    <style>
      ...
      /* Unavailable Strikethrough Style */
      .option-unavailable { position: relative; display: inline-block; color: #aaa; padding: 0 4px; 
    ...
    <body>
      <h3>Scheel-Mann Status <span class="sm-date">Updated: %s</span></h3>
    ...
    # Save as index.html so GitHub Pages serves it automatically
